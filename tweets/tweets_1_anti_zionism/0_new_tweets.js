...
1. Antizionism is a totalizing logic that shuts out contradiction. The movement casts Jewish national self-determination as the root cause of global injustice.
- Person in Nigeria telling them they should pray for Gaza
- Ven diagram with everything (white supremacy, genocide, climate chagne, etc.) being blamed on Zionism
- Mamdani: boots of NYPD were laced by IDF 


2. The hate is self-justifying, creating moral hysteria
- Jewish person gets assaulted: "Yeah but that's nothing compared to what's happening in Gaza"
- Fake picture of dead child "Yeah but they still exist"
- Email denying an Israeli person access to spa weekend, signed "Kindly" (also No. 3)

3. The difference this time: The hate is wrapped in the language of compassion and social justice
- Email denying an Israeli person access to spa weekend, signed "Kindly" (also No. 2)

4. Libels that can't be refuted
- BBC directs its journlaists to blame Israel for any food shortages regardless of facts
- 


5. Antizionism echoes practices of Naziism
- "Making lists"
- No Jews allowed/No Israeli prodcuts allowed/No Zionists allowed
- Blocking Jewish students from reaching classes on campuses


6. Antizionism rejects/rewrites Jewish history
- Ann Frank Memorial descecration
- Rejects that Jews were indigenous to the area despite (sewer manhole cover that says British Palestine but also "Land of Israel")



-------

1. Antizionism is intimidating, echoes of Naziism
2. Antizionism is violent
...
1. anti-Jewish libels spread through society: Racism begins with a presumption of guilt: Irrational hatred of who people are is recast as moral outrage over what they have allegedly done
- "Stop killing babies"
- al-Ahli hospital bombing
- Claims of deliberate starvation
- Allegations of civilian targeting
- The genocide libel



3. and rapidly recode entire ideological systems: the movement casts Jewish national self-determination as the root cause of global injustice. 
- greta thunberg switching from climate to palestinianism
- nypd boots are laced by the idf
- everything is palestinianism (climate change, white supremacy, workers rights, etc.)
- yeah, but whatever that person has to deal with is nothing compared to what they're dealing with in gaza
- NGO person telling a starving child in Nigeria he should pray for Gaza


4. the hatred and slanders are self-justifying


5. using the language of social justice, compassion, and kindness
- email from spa woman signed "kindly"


6. moral certainty

7. reshape institutions in their path

8. Their power does not comes from repetition, outrage, and a totalizing logic that shuts out contradiction

9. Antizionism is hatred not of Jewish people individually -- although that partially exists too -- but hostility of Jewish peoplehood: It is precisely this collective soul—the idea of the Jewish people as a moral and metaphysical unity—that antizionist ideology seeks to subvert.

10. They deny the reality of Jewish peoplehood and replace it with a false moral code of accusation—one that symbolically recasts Jewish collective identity as a singular threat to justice.
- Example 000000007E: pro-Palestinian protestor is against a Jewish state but has no problem with Islamic states

11. Antizionist discrimination: marking anyone as a Zionist—regardless of their own identification or understanding—and treating them unequally on that basis.
- Mamdani's threat to shut down Technion's NYC campus falls under this rubric


Adding my own:
12. They're full of hate
13. Antizionism is intimdating, fascistic, and violent, 



1. Add keyword's to front end and back end
2. Add support for 'nodate'
- should be a separate section/page

Claim: Rhetorical games
- Example 000000007E: pro-Palestinian protestor is against a Jewish state but has no problem with Islamic states
- 000000007F: TUcker Carlson saying we should stop talking about Israel so much, followed by him talking about Israel non-stop
...
Claim: antizionism is the new Naziism
- Nazis preventing Jews from entering college campus and then same thing happening on Columbia
- No Jews allowed; no Israeli products allowed
- Two Israelis killed while killer yelled 'Free Palestine'

Claim: Media launders lies, is pro-Hamas and anti-Israel
- BBC had to correct 2 stories per week about Israel
- al-Alhi lie with a NY Times showing a building that wasn't even the hospital 
- thin child on front page of NY Times who had cerebral palsy [starvation]



Lies:
- Genocide lie, compare pictures of fat Gazans with starved [genocide]


--

Media lies from al-Ahli

Rashida Tlaib still referencing the al-Ahli 'massacre' despite evidence it was a PIJ rocket
...
const claim7 = {
  dateAdded: "",
  claimText: "'Palestinian doctors' say, or 'Israel targeted a Palestinian journalist!' are common lines of argument for pro-Palestinain (pro-Hamas) voices. Like international NGOs, Gazan doctors and journalists are not neutral, professional observers. They are actively involved in the propoganda/military effort and do not have integrity.",
  claimShortText: "'Palestinian Doctors and Journalists'",
  claimId: "000000007",
  incidentIds: []
}
...
const claim8 = {
  dateAdded: "",
  claimText: "Palestinians eagerly sacrifice their own children for their evil cause.",
  claimShortText: "'Stop killing children!'",
  claimId: "000000008",
  incidentIds: []
}
...
const claim9 = {
  dateAdded: "",
  claimText: "The violence is because of Islam because jihad is part of their religion, culture and history.",
  claimShortText: "'They want to die'",
  claimId: "000000009",
  incidentIds: []
}
...
const examples7 = [
  ...
  },
  {
    ...
    date: "2025-11-11",
    claimIds: ["00000001"],
    exampleId: "000000007F",
    keywordIds: [],
    text: "Tucker Carlson says we should stop talking about Israel, but as this video demonstrates, all he talks about is Israel.",
    themTweets: [{ id: "1988255935102386434"}],
    usTweets: []
  }
]

module.exports = { examples7 };
