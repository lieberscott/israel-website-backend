const claim6z = {
  dateAdded: "",
  claimText: "Anti-Zionism is a hate movement",
  claimShortText: "Hate",
  claimId: "6z"
}
...
const examples6z = [
  ...
  },
  {
    ...
    exampleId: "6z06",
    keywordIds: [],
    text: "Susanne DeWitt, an 89 year-old Holocaust survivor who was arrested and sent to Dachau Concentration Camp at age 4, was repeatedly heckled by demonstrators as she spoke in favor of the City of Berkeley's Holocaust Remembrance Day proclamation.",
    standaloneTweets: ["1773191105149833554"],
    themTweets: [],
    usTweets: []
  },
  {
    dateAdded: "",
    date: "2024-03-27",
    claimIds: ["6z", "2", "4", "21", "30x", "30y", "5"],
    exampleId: "6z07",
    keywordIds: [],
    text: "Speaker: 'Last week, my 7-year-old Jewish son told me he heard a group of students at his school say Jews are stupid.' *Antizionist laughs* Antizionist: 'Zionists ARE stupider!' Speaker: 'They said Jews.'",
    standaloneTweets: ["1773204116308652398"],
    themTweets: [],
    usTweets: []
  },
  {
    ...
    exampleId: "6z08",
    keywordIds: [],
    text: "Antizionists: 'F*cking murderous k*ke.' 'F*cking die.' 'Keep it moving b*tch.'",
  ...
  },
  {
    ...
    claimIds: ["6z", "2"],
    exampleId: "6z09",
    keywordIds: ["AnaKasparian"],
    text: "Prominant antizionist and Young Turks host Ana Kasparian: 'Who gives a fuck what you think about anything related to America or its local elections. Stay in your fucking lane and out of our country, scumabag.' Then: 'Strictly the terrorist genociders, and that includes non-Jews who choke on their genitals like you.' Ana also comments extensively on her views about Israel and Benjamin Netanyahu despite not being Israeli.",
    standaloneTweets: ["1988685670567801040"],
    themTweets: [],
    usTweets: []
  },
  {
    ...
    exampleId: "6z10",
    keywordIds: [],
    text: "Shakeba Morrad, an appellate attorney at Office of General Counsel for U.S. @DeptVetAffairs, posted (& later deleted) a video of herself on Instagram mocking Israelis pleading for the return of their citizens being held hostage by Hamas.",
...
module.exports = { claim6z, examples6z };