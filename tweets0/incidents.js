export const incident1 = {
  ...
  dateAdded: "",
  claimIds: [{
      claimId: 1, exampleIds: [00000000A, 00000000B, 00000000C],
...
export const incident2 = {
  ...
  claimIds: [{
      claimId: 000000003, incidentText: Palestinians kill and torture dogs, exampleIds: [00000000E]
    }
  ]
}
...
export const incident3 = {
  ...
  claimIds: [{
      claimId: 000000004, incidentText: All they do is lie, exampleIds: [00000000F]
    }
  ]
}
...
export const incident4 = {
  ...
  claimIds: [{
      claimId: 000000005, incidentText: They dont want a two-state solution. They want all of it., exampleIds: [00000000G]
    }
  ]
}